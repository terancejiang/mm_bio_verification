...
def oid_challenge_classes() -> list:
    ...
    return [
        ...
        'Flower', 'Window', 'Hat', 'Human heads', 'Dog', 'Human arm', 'Drink',
...
def oid_v6_classes() -> list:
    ...
    return [
        ...
        'Dumbbell', 'Human heads', 'Bowl', 'Humidifier', 'Porch', 'Lizard',
...
def objects365v1_classes() -> list:
    ...
    return [
        ...
        'machinery vehicle', 'tent', 'shampoo/shower gel', 'heads phone',
